        ...
        < div className="mt-20" >
            ...
            <div className="flex flex-col border-2 p-4 gap-4 rounded-lg">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex-1 flex items-center h-10 border-2 rounded-lg pl-3"><span>{email}</span></div>
                </div>
                {/* <div className="flex gap-4">
                    <div className="border-2 rounded-lg h-10 w-24 flex items-center justify-center bg-sky-500"><span>Email</span></div>
                ...
                {/* plans */}
                <div className="flex gap-4">
                    <div className="border-2 rounded-lg h-10 w-24 flex items-center justify-center bg-sky-500"><span>Plans</span></div>
                    <div className="flex-1 flex items-center h-10 border-2 rounded-lg pl-3"><span>{plans}</span></div>
                </div>
                {/* <div className="flex gap-4">
                    <div className="border-2 rounded-lg h-10 w-24 flex items-center justify-center bg-sky-500"><span>Plans</span></div>
                    <div className="flex flex-col h-16 flex-1 ">
